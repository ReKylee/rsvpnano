...
void RowPrefixCanvas::writeFastVLine(int16_t x, int16_t y,
...
void RowPrefixCanvas::writeFastVLineCore(int16_t x, int16_t y,
                                        int16_t h, uint16_t color)
{
...
void RowPrefixCanvas::writeFastHLine(int16_t x, int16_t y,
...
void RowPrefixCanvas::writeFastHLineCore(int16_t x, int16_t y,
                                        int16_t w, uint16_t color)
{
...
void RowPrefixCanvas::writeFillRectPreclipped(int16_t x, int16_t y,
...
void RowPrefixCanvas::drawIndexedBitmap(
    int16_t x, int16_t y,
...
void RowPrefixCanvas::draw16bitRGBBitmap(int16_t x, int16_t y,
...
void RowPrefixCanvas::draw16bitRGBBitmapWithTranColor(
    int16_t x, int16_t y,
...
void RowPrefixCanvas::draw16bitBeRGBBitmap(int16_t x, int16_t y,
                                          uint16_t *bitmap, int16_t w, int16_t h)
{
  markDirtyRect(x, y, w, h);
...
{
  // Flushes native rows 0..N only. This avoids arbitrary panel windows while still honoring rotation.
  switch (_rotation)
  {
  case 1:
    return _dirty_right;
