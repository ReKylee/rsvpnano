...
void LifeScreensaver::seedOscillatorGardenScene() {
  ...
  stampPattern(life_, kPatternGlider,
               ...
               clampOrigin(rows_, kPatternGlider.height, static_cast<int>(rows_) - 6),
               LifeTransform::Rotate180);
}

void LifeScreensaver::seedMethuselahBurstScene() {
  stampPattern(life_, kPatternRpentomino, clampOrigin(columns_, kPatternRpentomino.width, static_cast<int>(columns_ / 2) - 22),
               centeredOrigin(rows_, kPatternRpentomino.height));
  stampPattern(life_, kPatternAcorn, clampOrigin(columns_, kPatternAcorn.width, static_cast<int>(columns_ / 2) + 12),
               centeredOrigin(rows_, kPatternAcorn.height) + 6);
  stampPattern(life_, kPatternDiehard, clampOrigin(columns_, kPatternDiehard.width, static_cast<int>(columns_ / 2) - 4),
