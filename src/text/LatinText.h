...
namespace LatinText {
    ...
    inline uint8_t byteValue(char c) {
    ...
    inline bool isDigit(uint8_t value) {
        return value >= '0' && value <= '9';
    }

    inline bool isUppercaseLetter(uint8_t value) {
        return (value >= 'A' && value <= 'Z') || (value >= 0xC0 && value <= 0xD6) || (value >= 0xD8 && value <= 0xDE)
            || isCustomUppercaseLetter(value);
    }

    inline bool isLowercaseLetter(uint8_t value) {
        return (value >= 'a' && value <= 'z') || value == 0xDF || (value >= 0xE0 && value <= 0xF6)
            || (value >= 0xF8 && value <= 0xFF) || isCustomLowercaseLetter(value);
    }
