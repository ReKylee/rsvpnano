...
struct BatteryState {
    ...
    BatteryModel view() const { return {percent, voltage, charging, (labelMode & 1U) != 0}; }
...
public:
    ...
    bool openBook(ui::Context& ui, StorageManager& storage, Preferences& preferences, size_t index,
                  uint32_t nowMs);
...
private:
    ...
    enum class TouchIntent : uint8_t { None, PlayHold, Scrub, Wpm };
